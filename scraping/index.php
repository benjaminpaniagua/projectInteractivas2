...
// $img_recorted = ['img/recorted/RoastedButternutSquashSalad.png', 'img/recorted/GreekCouscousSalad.png', 'img/recorted/PecanChickenSalad.png', 'img/recorted/CopycatKFCColeslaw.png', 'img/recorted/HeartsofPalmandAvocado.png', 'img/recorted/RedPearPomegranateandGorgonzolaSalad.png', 'img/recorted/GreenGoddessSalad.png', 'img/recorted/CitrusandPomegranateSalad.png', 'img/recorted/CelebrateSummerWatermelon.png', 'img/recorted/RoastedCauliflowerSalad.png'];
// $index=0;
// for ($i = 0; $i < 20; $i++) {
//     if ($i == 7 || $i == 8 || $i == 9 || $i == 10 || $i == 12 || $i == 13 || $i == 14 || $i == 15 || $i == 18 || $i == 19) {
//     } else {
